...
def Mstat2R(mean, std, unit='Earth', sample_size=int(1e3), classify = 'No'):	
	"""
...
def Rstat2M(mean, std, unit='Earth', sample_size=int(1e3), grid_size=int(1e3), classify = 'No', return_post=False):	
	"""
